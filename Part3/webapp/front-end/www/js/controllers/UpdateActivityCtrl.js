...
.controller('UpdateActivityCtrl', ['$scope', '$rootScope', '$state', '$stateParams', '$ionicHistory', '$localStorage', '$timeout', '$utils', 'aDetail', 'ActivityService', '$translate', '$translatePartialLoader',

    function ($scope, $rootScope, $state, $stateParams, $ionicHistory, $localStorage, $timeout, $utils, aDetail, ActivityService, $translate, $translatePartialLoader) {
        ...
        $translatePartialLoader.addPart('update_activity');
        $translate.refresh();
    }
]);
